  ...
  <nav class="fixed z-10 flex items-center justify-between w-full h-16 p-5 pointer-events-none frosted-glass">
    ...
    <a use:$url href="/jobs" class="flex items-center outline-none pointer-events-auto logo-link">
      ...
      <svg class="ml-1.5 z-20 w-10 h-10 p-2 rounded-full logo" xmlns="http://www.w3.org/2000/svg"
        ...
        <defs>
          <path id="a" d="M271.34 350.42c-2.16-2.22-5.99-12.61-6.61-17.54-.61-4.93
            1.92-9.23 5.3-9.51 2.25-.19 3.86 1.21 4.83 4.22-.91 16.69-2.08
            24.3-3.52 22.83z" />
          <path id="b" d="M224.06 357.51c-2.76-3.69-7.34-21.3-7.92-29.72-.57-8.41 2.99-15.9
            7.48-16.55 3-.44 5.07 1.9 6.21 7-2.01 28.63-3.93 41.72-5.77 39.27z" />
          <path id="c" d="M177.16 363.7c-2.89-3.86-7.69-22.29-8.29-31.1-.6-8.8 3.13-16.63
            7.83-17.32 3.13-.45 5.3 1.99 6.49 7.32-2.1 29.97-4.11 43.67-6.03
            41.1z" />
          <path id="d" d="M361.5 280l26.5-4.32-25-10.5" />
          <path id="e" d="M286.5 154.7c-5.67-31.24-28.59-39.95-37.59-40.54-8.99-.58-25.59
            14.08-14.06 53.26 7.68 26.13 21.5 40.01 41.46 41.65 10.58-15.41
            13.98-33.54 10.19-54.37z" />
          <path id="f" d="M252.5 340.18c82-1.5 109-45.5 110-68.18S354 185.68 248
            184s-120.62 54.63-120 83.68c1.13 49.04 42.5 74 124.5 72.5z" />
          <path id="g" d="M324.5 201.68c-2.68-.84 9.87 13.38 13.46 28.39s3.05 18.55 3.54
          ...
          <path id="i" d="M293.5 362.06c2.56-2.67 7.92-16.23 9.19-22.87
            1.28-6.64-.83-12.94-4.34-13.9-2.34-.64-4.21 1.02-5.61 4.96-1.2
            22.98-.94 33.58.76 31.81z" />
          <path id="j" d="M216.5 338.75c19.06.59 40.5 1.6 52.75 1.43C291 319.51 316 299.5
          ...
          <path id="k" d="M252 340c52-2.12 74.31-10.5 98.33-41.83-19.64 6.33-44.02 20.83-92
            21.83-20.62.43-38.88 2.81-58.33 1.77-19.45-1.03-47.73-11.37-56-14.44
            23.16 25.29 56 34.8 108 32.67z" />
          <path id="l" d="M320 182.18c26.5-17.5 25.5-42 22.5-50.5s-23-18-54.5 8c-21
            17.33-28.33 35.5-22 54.5 18.33 3.66 36.33-.34 54-12z" />
          <path id="m" d="M328.43 346.9c2.56-2.67 8.72-17.83 9.99-24.47 1.28-6.64
            2.29-8.47-1.22-9.43-2.34-.64-5.38 2.36-9.13 9-1.46 18.38-1.34
            26.68.36 24.9z" />
          <path id="n" d="M240 368c3.33-3.48 10.33-21.19 12-29.86
        ...
        <path fill="#161008" d="M187.64 282.8c0 1-.85 1.81-1.9
        ...
        <path fill="#161008" d="M211.12 283.37c0 1.04-.89 1.88-1.98
          1.88s-1.97-.84-1.97-1.88c0-1.03.88-1.87 1.97-1.87s1.98.84 1.98 1.87z" />
        <path fill="#161008" fill-opacity=".13" d="M356.44 372.25c0 13.66-45.8 24.75-102.22 24.75S152 385.91 152
            ...
            <svg class="ml-1.5 z-20 w-10 h-10 p-2 rounded-full logo" xmlns="http://www.w3.org/2000/svg"
              ...
              <defs>
                <path id="a" d="M271.34 350.42c-2.16-2.22-5.99-12.61-6.61-17.54-.61-4.93
                  1.92-9.23 5.3-9.51 2.25-.19 3.86 1.21 4.83 4.22-.91 16.69-2.08
                  24.3-3.52 22.83z" />
                <path id="b" d="M224.06 357.51c-2.76-3.69-7.34-21.3-7.92-29.72-.57-8.41
                  2.99-15.9 7.48-16.55 3-.44 5.07 1.9 6.21 7-2.01 28.63-3.93
                  41.72-5.77 39.27z" />
                <path id="c" d="M177.16 363.7c-2.89-3.86-7.69-22.29-8.29-31.1-.6-8.8
                ...
                <path id="f" d="M252.5 340.18c82-1.5 109-45.5 110-68.18S354 185.68 248
                  184s-120.62 54.63-120 83.68c1.13 49.04 42.5 74 124.5 72.5z" />
                <path id="g" d="M324.5 201.68c-2.68-.84 9.87 13.38 13.46 28.39s3.05 18.55
                ...
                <path id="i" d="M293.5 362.06c2.56-2.67 7.92-16.23 9.19-22.87
                  1.28-6.64-.83-12.94-4.34-13.9-2.34-.64-4.21 1.02-5.61 4.96-1.2
                  22.98-.94 33.58.76 31.81z" />
                <path id="j" d="M216.5 338.75c19.06.59 40.5 1.6 52.75 1.43C291 319.51 316
                  299.5 312
                ...
                <path id="k" d="M252 340c52-2.12 74.31-10.5 98.33-41.83-19.64 6.33-44.02
        ...
        <span class="inline-flex justify-center mt-4 cursor-pointer sm:ml-auto sm:mt-0 sm:justify-start">
          <a href="https://www.quillerbee.com/"
            ...
            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
              viewBox="0 0 24 24">
              <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0
                011-1h3z" />
            </svg>
          </a>
          <a href="https://www.quillerbee.com/"
          ...
          <a href="https://www.quillerbee.com/"
            ...
            <svg fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
              ...
              <path stroke="none" d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6
