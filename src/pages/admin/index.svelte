...
<section class="absolute top-0 flex flex-col justify-around w-full p-10 pointer-events-none h-3/4">
	<div class="relative flex flex-col items-center max-w-3xl px-6 mx-auto text-white">
		<div
		...
		<div class="flex mb-3 text-xs font-semibold">
			<div class="flex mr-2">
				<svg class="mr-0.5 text-purple-400" width="15" height="15" xmlns="http://www.w3.org/2000/svg"
			...
			<div class="flex">
				<svg class="mr-0.5 text-purple-400" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
					viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd"
		...
		<blockquote class="text-center">
			If you're someone, just starting out in the industry or looking to better yourself or trying to find
			your way in life. You have come to the right place!
		</blockquote>
	</div>
</section>
