...
<section
	...
	<div
		...
		<div class="flex items-center mb-3 text-xs font-semibold">
			<div class="flex items-center mr-2">
				...
				<a href="https://www.quillerbee.com" class="text-sm pointer-events-auto">https://www.quillerbee.com</a>
			</div>
			<div class="flex items-center">
				...
				<a href="@mailto:abhijit.kar@derpycoder.com" class="text-sm pointer-events-auto">abhijit.kar@derpycoder.com</a>
			</div>
		</div>
