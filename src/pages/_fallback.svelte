		...
		<div class="circle circle--inner">
			...
			<div class="circle oh">
				...
				<svg class="astronaut-wire" width="259" height="823">
					<use xlink:href="#astronaut-wire"></use>
				</svg>
				...
				<div class="astronaut-hands">
					<div class="astronaut-hand hand--left">
						<svg>
							<use xlink:href="#astronaut-left-hand"></use>
						</svg>
					</div>
					<div class="astronaut-hand hand--right">
						<svg>
							<use xlink:href="#astronaugh-right-hand"></use>
						</svg>
					</div>
				</div>
			</div>
			<a use:$url href="/jobs" class="pointer-events-auto button"
				>GO HOME</a>
		</div>
