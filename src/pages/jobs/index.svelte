...
<div
	...
	<h2 class="inline-flex w-auto mb-6 text-xl font-bold text-left text-white">
		<a href="https://www.quillerbee.com/" class="focus:outline-none"
		...
		<div class="flex items-start justify-between mb-5">
			<div class="flex p-5">
				...
				<div class="flex flex-col ml-4 text-left">
					<div>
						<div
							class="w-42 mb-0.5 h-5 mr-2 bg-gray-700 rounded animate-pulse">
						</div>
						<div>
							<div
								class="inline-block w-16 h-4 bg-gray-700 rounded animate-pulse">
							</div>
							<div
								class="inline-block w-20 h-4 bg-gray-700 rounded animate-pulse">
							</div>
						</div>
					</div>
					<div class="flex">
						<div
							class="w-20 mr-2 bg-gray-700 h-7 rounded-2xl animate-pulse">
						</div>
						<div
							class="w-20 mr-2 bg-gray-700 h-7 rounded-2xl animate-pulse">
						</div>
			...
			<div class="flex pt-4 pr-5">
				<div
					class="w-8 h-8 mr-1 bg-gray-700 rounded-full animate-pulse">
				</div>
		...
		<div class="flex justify-between px-5 py-2 border-t border-gray-800">
			<div class="flex items-center justify-between w-full text-xs">
				<div class="flex items-center">
					<div
						class="flex items-center w-8 h-8 mr-3 bg-gray-700 rounded-full animate-pulse">
					</div>
					<div
						class="flex items-center justify-center w-20 h-5 mr-2 bg-gray-700 rounded animate-pulse">
					</div>
					<div
						class="flex items-center justify-center w-20 h-5 mr-2 bg-gray-700 rounded animate-pulse">
					</div>
				...
				<div class="items-center hidden mr-3 sm:flex">
					<div class="w-24 h-5 bg-gray-700 rounded animate-pulse">
					</div>
				</div>
			</div>
			<div class="flex">
	...
	<section
		...
		<div class="flex items-start justify-between mb-5">
			<div class="flex p-5">
				...
				<div class="flex flex-col ml-4 text-left">
					<div class="mb-1">
						<div class="relative flex items-center">
							<div class="mr-2 truncate">Frontend Engineer</div>
						</div>
		...
		<div
			class="flex justify-between px-5 py-2 text-gray-500 border-t border-gray-200 border-solid">
			<div class="flex items-center justify-between w-full text-xs">
				<div class="flex">
					<div class="flex items-center mr-3">
						<svg class="mr-1 mb-0.5" width="15" height="15">
					...
					<div class="flex items-center justify-center mr-2">
						...
						<a
							class="focus:outline-none hover:text-gray-700 focus:text-gray-700"
							href="https://www.quillerbee.com/">
							JavaScript
						</a>
					</div>
